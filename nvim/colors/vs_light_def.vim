" Light (Visual Studio) color scheme — 16-color terminal fallback
" Ported from vim/.vim/colors/vs_light_def.vim
...
" nvim-tree
" =====================
hi NvimTreeFolderName ctermfg=4 cterm=bold
hi NvimTreeOpenedFolderName ctermfg=4 cterm=bold
